...
required_terms = [
    ...
    "No external search",
    "Search Local State MOCK",
    "clear_local_search_mock",
    "local_search_mock",
    "clearLocalSearch",
    "runLocalSearch",
    "localSearchResults",
    ...
    "download_workspace_package_mock",
    "import_workspace_package_mock",
    "export_workspace_package_mock",
